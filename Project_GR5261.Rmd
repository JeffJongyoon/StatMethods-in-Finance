...
sharpe07 <- (er07[1] - rf/252)/sigma07[1]*sqrt(252)
...
sharpe0809 <- (er0809[1] - rf/252)/sigma0809[1]*sqrt(252)
...
sharpe1617 <- (er1617[1] - rf/252)*252/(sigma1617[1]*sqrt(252))
...
sharpe17 <- (er17[1] - rf/252)/sigma17[1]*sqrt(252)
...
```{r}
ht %>%
  ggplot(aes(ETF,Year,fill=Weights)) +
  geom_tile(color= "white",size=0.1) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) 
